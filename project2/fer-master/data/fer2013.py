...
def load_data(path='datasets/fer2013.csv'):
...
def get_dataloaders(path='datasets/fer2013.csv', bs=64, augment=True):
    ...
    xval, yval = prepare_data(fer2013[fer2013['Usage'] == 'Validation'])
    xtest, ytest = prepare_data(fer2013[fer2013['Usage'] == 'Test'])
